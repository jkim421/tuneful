...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/tunesmith.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var signup = function signup(user) {
  return function (dispatch) {
    return _util_session_api_util__WEBPACK_IMPORTED_MODULE_1__["signup"](user).then(function (returnedUser) {
...
var login = function login(user) {
  return function (dispatch) {
    return _util_session_api_util__WEBPACK_IMPORTED_MODULE_1__["login"](user).then(function (returnedUser) {
      return dispatch(loginCurrentUser(returnedUser));
    }, function (errors) {
      return dispatch(receiveSessionErrors(errors.responseJSON));
    });
  };
...
var Root = function Root() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Welcome to tunesmith");
};
...
var errorsReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  errors: _session_errors_reducer__WEBPACK_IMPORTED_MODULE_1__["default"]
});
