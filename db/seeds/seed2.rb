...
classical = Genre.find_by(name: "Classical")
blues = Genre.find_by(name: "Blues")
funk = Genre.find_by(name: "Funk")

jahzzar_art = Artist.find_by(name: "Jahzzar")
loboloco_art = Artist.find_by(name: "Lobo Loco")
nctrnm_art = Artist.find_by(name: "Nctrnm")
oedipussy_art = Artist.find_by(name: "Oedipussy")
piercemurphy_art = Artist.find_by(name: "Pierce Murphy")
podingtonbear_art = Artist.find_by(name: "Podington Bear")
revolutionvoid_art = Artist.find_by(name: "Revolution Void")
theagrarians_art = Artist.find_by(name: "The Agrarians")

death = Album.find_by(title: "Death")
oedipussy = Album.find_by(title: "Oedipussy")
nighthawksep = Album.find_by(title: "Nighthawks EP")
thisisntmagic = Album.find_by(title: "This Isn't Magic")
bonvoyage = Album.find_by(title: "Bon Voyage")
nocturnes = Album.find_by(title: "Nocturnes")
rainy = Album.find_by(title: "Rainy")
thepoliticsofdesire = Album.find_by(title: "The Politics of Desire")
lastjoplinblues = Album.find_by(title: "Last Joplin Blues")

familyband = Album.find_by(title: "Family Band")
scenesfromthezoo = Album.find_by(title: "Scenes from the Zoo")
n3 = Album.find_by(title: "N3")
tojapan = Album.find_by(title: "To Japan")

oldermoodscolderbloods = Album.find_by(title: "Older Moods Colder Bloods")
lifespan = Album.find_by(title: "Life Span")
passages = Album.find_by(title: "Passages")
hotpotdancing = Album.find_by(title: "Hot Pot Dancing")
threadsoul = Album.find_by(title: "Thread Soul")
