...
jahzzar_art = Artist.create!(user_id: jahzzar.id, name: "Jahzzar", location: "Gijón, Asturias", bio: "Jahzzar’s music offers sounds for ideas, to enjoy and share, to use. No matter the language, just communicate.")
loboloco_art = Artist.create!(user_id: loboloco.id, name: "Lobo Loco", location: "Göppingen, Germany", bio: "")
nctrnm_art = Artist.create!(user_id: nctrnm.id, name: "Nctrnm", location: "Colton, CA", bio: "i'm nctrnm: singer, songwriter, experimental/electronic producer from  Colton, CA.")
oedipussy_art = Artist.create!(user_id: oedipussy.id, name: "Oedipussy", location: "San Francisco, CA", bio: "")
piercemurphy_art = Artist.create!(user_id: piercemurphy.id, name: "Pierce Murphy", location: "Denver, CO", bio: "Wherever you see me, I'm looking forward to sharing some music with you.")
podingtonbear_art = Artist.create!(user_id: podingtonbear.id, name: "Podington Bear", location: "Portland, OR", bio: "A mysterious bear named Podington took the Internet by storm in 2007, releasing three beautifully crafted songs a week. ")
revolutionvoid_art = Artist.create!(user_id: revolutionvoid.id, name: "Revolution Void", location: "Seattle, WA", bio: "Revolution Void is the moniker of 23-year-old producer and jazz pianist Jonah Dempcy. ")
theagrarians_art = Artist.create!(user_id: theagrarians.id, name: "The Agrarians", location: "Baltimore, MD", bio: "")

hificitytales = Album.create!(artist_id: jahzzar_art.id, title: "HiFi City Tales", genre_id: electronic.id, description: "Courage of our questions light years preserve and cherish that pale blue dot from which we spring Jean-François Champollion hundreds of thousands.", release_date: 2009)
kuddelmuddel = Album.create!(artist_id: jahzzar_art.id, title: "Kuddelmuddel", genre_id: funk.id, description: "Great turbulent clouds billions upon billions of brilliant syntheses made in the interiors of collapsing stars dispassionate extraterrestrial observer inconspicuous ", release_date: 2006)
supers = Album.create!(artist_id: jahzzar_art.id, title: "Super", genre_id: funk.id, description: "Champollion vastness is bearable only through love Hypatia not a sunrise but a galaxyrise a very small stage in a vast cosmic arena the ash of stellar alchemy.", release_date: 2005)
littlecaesar = Album.create!(artist_id: loboloco_art.id, title: "LITTLE CAESAR", genre_id: jazz.id, description: "Globular star cluster billions upon billions made in the interiors of collapsing stars tingling of the spine muse about Vangelis", release_date: 2006)
retro = Album.create!(artist_id: loboloco_art.id, title: "RETRO", genre_id: jazz.id, description: "A very small stage in a vast cosmic arena hundreds of thousands bits of moving fluff vanquish the impossible preserve and cherish that pale blue dot", release_date: 2013)
vagabond = Album.create!(artist_id: loboloco_art.id, title: "Vagabond", genre_id: blues.id, description: "The only home we've ever known rich in heavy atoms finite but unbounded a mote of dust suspended in a sunbeam extraordinary claims require extraordinary evidence courage of our questions", release_date: 2005)
acuerdo = Album.create!(artist_id: nctrnm_art.id, title: "ACUERDO", genre_id: electronic.id, description: "Tunguska event a very small stage in a vast cosmic arena worldlets a billion trillion", release_date: 2006)
equinox = Album.create!(artist_id: nctrnm_art.id, title: "EQUINOX", genre_id: electronic.id, description: "Sea of Tranquility citizens of distant epochs descended from astronomers kindling the energy hidden in matter bits of moving fluff ", release_date: 2007)
founded = Album.create!(artist_id: nctrnm_art.id, title: "FOUNDED", genre_id: electronic.id, description: "Stirred by starlight a still more glorious dawn awaits take root and flourish the sky calls to us stirred by starlight dream of the mind's eye", release_date: 2008)
death = Album.create!(artist_id: oedipussy_art.id, title: "Death", genre_id: pop.id, description: "Star stuff harvesting star light invent the universe a mote of dust suspended in a sunbeam how far away concept of the number one", release_date: 2011)
oedipussy = Album.create!(artist_id: oedipussy_art.id, title: "Oedipussy", genre_id: pop.id, description: "Dispassionate extraterrestrial observer extraplanetary preserve and cherish that pale blue dot shores of the cosmic ocean dream of the mind's eye birth", release_date: 2009)
nighthawksep = Album.create!(artist_id: piercemurphy_art.id, title: "Nighthawks EP", genre_id: rock.id, description: "Extraordinary claims require extraordinary evidence as a patch of light paroxysm of global death rings of Uranus", release_date: 2014)
thisisntmagic = Album.create!(artist_id: piercemurphy_art.id, title: "This Isn't Magic", genre_id: blues.id, description: "Two ghostly white figures in coveralls and helmets are soflty dancing concept", release_date: 2013)
bonvoyage = Album.create!(artist_id: podingtonbear_art.id, title: "Bon Voyage", genre_id: jazz.id, description: "Flatland vanquish the impossible the ash of stellar alchemy. ", release_date: 2018)
nocturnes = Album.create!(artist_id: podingtonbear_art.id, title: "Nocturnes", genre_id: classical.id, description: "Euclid network of wormholes preserve and cherish that pale blue dot a very small stage in a vast cosmic arena the sky calls to us star stuff harvesting star light.", release_date: 2012)
rainy = Album.create!(artist_id: podingtonbear_art.id, title: "Rainy", genre_id: classical.id, description: "A still more glorious dawn awaits shores of the cosmic ocean of brilliant syntheses gathered by gravity Orion's sword prime number?", release_date: 2016)
thepoliticsofdesire = Album.create!(artist_id: revolutionvoid_art.id, title: "The Politics of Desire", genre_id: pop.id, description: "Rich in mystery vanquish the impossible courage of our questions inconspicuous motes of rock and gas extraordinary claims", release_date: 2017)
lastjoplinblues = Album.create!(artist_id: theagrarians_art.id, title: "Last Joplin Blues", genre_id: rock.id, description: "Paroxysm of global death Tunguska event cosmic fugue astonishment great turbulent clouds prime number. ", release_date: 2018)

oldermoodscolderbloods = Album.create!(artist_id: theagrarians_art.id, title: "Older Moods Colder Bloods", genre_id: rock.id, description: "Drake Equation hundreds of thousands science at the edge of forever a very small stage in a vast cosmic arena Sea of Tranquility", release_date: 2008)
lifespan = Album.create!(artist_id: oedipussy_art.id, title: "Life Span", genre_id: pop.id, description: "Something incredible is waiting to be known globular star cluster great turbulent clouds citizens of distant epochs invent the universe with pretty stories for which there's little good evidence", release_date: 2013)
passages = Album.create!(artist_id: podingtonbear_art.id, title: "Passages", genre_id: jazz.id, description: "Apollonius of Perga Jean-François Champollion rich in heavy atoms tingling of the spine bits of moving fluff a billion trillion. ", release_date: 2008)
hotpotdancing = Album.create!(artist_id: loboloco_art.id, title: "Hot Pot Dancing", genre_id: pop.id, description: "Euclid kindling the energy hidden in matter descended from astronomers circumnavigated gathered by gravity ", release_date: 2018)
threadsoul = Album.create!(artist_id: revolutionvoid_art.id, title: "Thread Soul", genre_id: jazz.id, description: "Citizens of distant epochs stirred by starlight vastness is bearable only through love across the centuries Sea of Tranquility stirred by starlight.", release_date: 2007)

familyband = Album.create!(artist_id: theagrarians_art.id, title: "Family Band", genre_id: rock.id, description: "Laws of physics not a sunrise but a galaxyrise dream of the mind's eye radio telescope corpus callosum birth. ", release_date: 2006, featured: true)
scenesfromthezoo = Album.create!(artist_id: jahzzar_art.id, title: "Scenes from the Zoo", genre_id: rock.id, description: "Something incredible is waiting to be known not a sunrise but a galaxyrise extraordinary claims require extraordinary evidence", release_date: 2017, featured: true)
n3 = Album.create!(artist_id: nctrnm_art.id, title: "N3", genre_id: electronic.id, description: "Hearts of the stars Euclid science courage of our questions tingling of the spine finite but unbounded. Dispassionate extraterrestrial observer", release_date: 2018, featured: true)
tojapan = Album.create!(artist_id: piercemurphy_art.id, title: "To Japan", genre_id: classical.id, description: "Hypatia worldlets gathered by gravity a mote of dust suspended in a sunbeam. Hearts of the stars a mote of dust", release_date: 2008, featured: true)
